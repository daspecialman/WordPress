...
if ( ! function_exists( 'buzzstone_vc_get_css' ) ) {
	add_filter( 'buzzstone_filter_get_css', 'buzzstone_vc_get_css', 10, 2 );
	function buzzstone_vc_get_css( $css, $args ) {
...
.vc_tta-style-flat .vc_tta-tabs-list {
...
.wpb-js-composer .vc_tta.vc_tta-style-flat .vc_tta-tab.vc_active > a {
    color: {$colors['inverse_link']};
