...
if ( ! function_exists( 'buzzstone_trx_addons_add_theme_vars' ) ) {
	add_filter( 'buzzstone_filter_add_theme_vars', 'buzzstone_trx_addons_add_theme_vars', 10, 2 );
	function buzzstone_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'buzzstone_trx_addons_get_css' ) ) {
	add_filter( 'buzzstone_filter_get_css', 'buzzstone_trx_addons_get_css', 10, 2 );
	function buzzstone_trx_addons_get_css( $css, $args ) {
...
.trx_addons_hover_mask {
	...
	background: -moz-linear-gradient(-45deg, {$colors['text_link_06']} 0%, {$colors['text_link2_06']} 100%);
	background: -webkit-linear-gradient(-45deg, {$colors['text_link_06']} 0%,{$colors['text_link2_06']} 100%);
	background: linear-gradient(135deg, {$colors['text_link_06']} 0%,{$colors['text_link2_06']} 100%);
}
...
.trx_addons_emotions_title span {
	color: {$colors['text_link']};
}
...
.sc_blogger_filters .sc_blogger_filters_titles a:hover .trx_addons_extended_taxonomy_icon,
...
.sc_blogger_filters.style .sc_blogger_filters_titles a.active:hover .trx_addons_extended_taxonomy_icon,
.sc_blogger_filters.style .sc_blogger_filters_titles a.active .trx_addons_extended_taxonomy_icon {
	color: {$colors['inverse_link']} !important;
}
.sc_blogger_filters.style .sc_blogger_filters_titles a.active:hover,
...
.sc_blogger_filters.style .sc_blogger_filters_titles a:hover .trx_addons_extended_taxonomy_icon {
	color: {$colors['text_link']} !important;
}
.sc_blogger_filters.style .sc_blogger_filters_titles a:hover {
	color: {$colors['text_link']};
}
