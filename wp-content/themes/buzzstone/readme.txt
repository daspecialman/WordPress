...
Please install and activate it before starting to use the theme Buzzstone.
...
Theme documentation is available on http://buzzstone.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Buzzstone is Fontello.
